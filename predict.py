...
parsers.add_argument('--dir', type=str, default = 'flowers/train/1/image_06735.jpg', dest='data_dir',
...
parsers.add_argument('--class_names', action="store", 
                     dest="class_names", default='cat_to_name')
